...
export default function DonorCard({ donor, rank }) {
  return (
    <motion.article
      ...
      className="group relative overflow-hidden rounded-lg border border-ink/8 bg-white/60 p-5 shadow-[0_20px_50px_rgba(20,17,15,0.05)] transition-all duration-500 hover:-translate-y-1 hover:border-gold/30 hover:shadow-[0_28px_60px_rgba(20,17,15,0.1)]"
    >
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
        <div className="relative mx-auto h-36 w-36 shrink-0 overflow-hidden rounded-lg border border-gold/20 bg-parchment sm:mx-0">
          <img
            src={donor.photo_url}
            alt={donor.name}
