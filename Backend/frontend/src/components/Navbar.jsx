        ...
        <Link to="/" className="group flex items-center gap-3">
          <div className="relative h-12 w-12 overflow-hidden rounded-full border border-gold/30 bg-parchment shadow-[0_8px_24px_rgba(20,17,15,0.08)] transition-transform duration-300 group-hover:scale-105">
            <img
              ...
              onError={(e) => {
                e.currentTarget.src =
                  "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Crect fill='%23F8F5EF' width='100' height='100'/%3E%3Ccircle cx='50' cy='50' r='40' fill='none' stroke='%23D6C8A9'/%3E%3Ctext x='50' y='60' text-anchor='middle' font-size='34' fill='%23B8952E'%3Eશ%3C/text%3E%3C/svg%3E";
              }}
            />
          </div>
          <div className="hidden sm:block">
            <p className="font-gujarati text-sm font-semibold leading-tight text-ink">
              સંકલ્પ સેવા સમર્પણ
            </p>
            <p className="text-[10px] uppercase tracking-editorial text-mist">
              Charitable Trust
            </p>
          </div>
        </Link>
