...
export default function Gallery() {
  ...
  return (
    <section className="inner-page-shell mx-auto max-w-7xl px-5 pb-24 pt-36 md:px-8">
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-ink/8 bg-white/55 px-8 py-20 text-center text-mist">
        ...
        <div className="columns-1 gap-5 sm:columns-2 lg:columns-3">
          {photos.map((photo, index) => (
            <motion.a
              ...
              className="group mb-5 block break-inside-avoid overflow-hidden rounded-lg border border-ink/8 bg-white/50"
            >
              <img
                src={photo.image_url}
                alt="Trust event"
