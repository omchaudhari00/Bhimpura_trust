  ...
  return (
    <section className="mx-auto max-w-5xl px-5 pb-24 pt-36 md:px-8">
      ...
      <div className="space-y-8 text-lg leading-relaxed text-earth">
        <p>
          સંકલ્પ સેવા સમર્પણ ચેરીટેબલ ટ્રસ્ટ is dedicated to community seva,
          temple development, and supporting the people of Bhimpura through
          collective compassion and action.
        </p>
        <p>
          Guided by the belief that <span className="font-gujarati text-ink">સેવા એ જ સાચો સંકલ્પ</span>,
