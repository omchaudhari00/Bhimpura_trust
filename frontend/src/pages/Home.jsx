      ...
      <section className="mx-auto max-w-7xl px-5 py-24 md:px-8">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="font-display text-6xl font-medium tracking-tighter text-ink md:text-[5rem] lg:text-[6rem] leading-none">
              Generous<br/>Donors.
            </h2>
          </div>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {topDonors.length === 0 ? (
            <p className="col-span-full rounded-[2rem] border border-ink/8 bg-white/40 px-8 py-16 text-center text-mist">
